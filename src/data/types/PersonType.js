...
import {
  getN0deBy_id, // eslint-disable-line camelcase
  getN0deByPath,
...
const PersonType = new ObjectType({
  ...
  fields: () => ({
    ...
    // 	type: N0deType,
    // 	description:
    // 'All n0des created by this person, they are not stored on the person object but its
    ...
    // 	type: N0deType,
    // 	description:
    // 	'The persons navigation items, these can be any n0de they want, all stored in a seperate list.',
    // 	resolve: (person) => {
    // 		if (person.n0de) {
    // 			return getN0desBy_id(person.n0de);
    // 		}
