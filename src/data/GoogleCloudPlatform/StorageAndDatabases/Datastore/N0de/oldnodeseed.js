...
const n0des = [
	{
		_id: 'example00001000000000000000000000001',
		path: 'examples/component-type-examples',
		type: 'edge',
		title: 'Component Type Examples',
		nodeEdge: [],
	},
	{
		...
		n0de: 'thing0001000000000000000000000000001',
		n0deList: ['interface000010000000000000000000001', 'interface000010000000000000000000002'],
	},
	{
		_id: 'thing0001000000000000000000000000001',
		path: 'examples/interface-thing/default',
		public: true,
		type: 'interface_thing',
		title: 'Display N0de',
		styles: 'THINGID',
		n0de: 'THINGID(HOMETHING)',
	},
	{
		_id: 'interface000010000000000000000000001',
		path: 'examples/interface-navigation/default',
		public: true,
		type: 'interface_navigation',
		title: 'Left Navigation',
		styles: 'THINGID',
		n0deList: ['THINGID(ALL_THINGS)', 'THINGID(THING_TYPES)', 'THINGID(LINK_TO_MYIWORLDS_REPO)'],
	},
	{
	...
	},
	{
		...
		path: 'examples/content-list/default',
		public: true,
		type: 'content_list',
	...
	},
	{
		...
		path: 'examples/image-svg/default',
		public: true,
		type: 'image_svg',
		title: 'ALT_TEXT',
		blob: {
...
export default async function generateN0des() {
	n0des.map((n0de) => {
		createN0de(n0de);
